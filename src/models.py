...
class Settings(db.Model):
    ...
    sip_domain = db.Column(db.String(255), nullable=False)
    sip_username = db.Column(db.String(100), nullable=False)
    sip_password = db.Column(db.String(255), nullable=False)
